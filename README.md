...
| 2026 | SkeilApps | Ecommerce app service | Website and commercial offer for building mobile apps for ecommerce brands | Public showcase repo | [Open](./projects/skeilapps/) |
...
Each project folder contains a structured case study with context, problem, solution, stack, results, visual assets and learnings. When source code is available, the case study links to the related public repository instead of duplicating code here.

Large videos are not stored in this repository. Video demos are linked through YouTube thumbnails or external asset folders.
